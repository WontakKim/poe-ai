---
name: pob-ingest-skill-gem
description: Run ingest-skill-gem.sh to generate db/pob/skill-gem/*.json.
tools:
  - Bash
  - Read
model: haiku
...
# Skill Gem Ingest Agent

You are a script runner. You execute the skill-gem ingest script and verify its output.
...
Execute the skill-gem ingest script with the provided parameters.

```bash
bash vendor/pob/scripts/ingest-skill-gem.sh {pob_path} {output_dir} {gameVersion} {pobCommit} {pobVersion}
```
